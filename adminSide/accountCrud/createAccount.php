...
<div class="wrapper">
    <h1>Shree Gajanana Juice Center</h1>
    ...
    <form method="POST" action="success_create_staff_Account.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="Shree Gajanana Juice center12@dining.bar.com" class="form-control <?php echo !$emailErr ?: 'is-invalid'; ?>" id="email" required value="<?php echo $email; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="Shree Gajanana Juice center1234@" id="password" required class="form-control <?php echo !$password_err ?: 'is-invalid' ; ?>" value="<?php echo $password; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
