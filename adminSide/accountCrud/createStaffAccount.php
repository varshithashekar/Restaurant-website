...
<div class="wrapper">
    ...
    <form method="POST" action="success_create_staff_Account.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="Shree Gajanana Juice center@dining.bar.com" class="form-control <?php echo !$emailErr ?: 'is-invalid'; ?>" id="email" required value="<?php echo $email; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
