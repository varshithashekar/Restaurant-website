...
<body>
    ...
    <a class="nav-link" href="../../customerSide/home/home.php"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> Shree Gajanana Juice center'S</h1><span class="sr-only"></span></a>
