...
<body>
    ...
    <div class="register_wrapper"> <!-- Updated class name -->
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> Shree Gajanana Juice center</h1><span class="sr-only"></span></a><br>
